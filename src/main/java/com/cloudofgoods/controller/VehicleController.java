...
import com.cloudofgoods.document.Vehicle;
import com.cloudofgoods.search.SearchRequestDTO;
import com.cloudofgoods.service.VehicleService;
import com.cloudofgoods.service.helperdummy.VehicleDummyDataService;
...
public class VehicleController {
    ...
    public List<Vehicle> searchCreatedSince(@RequestBody final SearchRequestDTO dto, @PathVariable @DateTimeFormat(pattern = "yyyy-MM-dd") final Date date) {
